...
const DEFAULT_EXS = {
    'c1': [{ id: 'e1', name: '槓鈴臥推' }, { id: 'e2', name: '啞鈴飛鳥' }, { id: 'e3', name: '機械胸推' }, { id: 'c1s', name: '超級組' }],
    'c2': [{ id: 'e4', name: '滑輪下拉' }, { id: 'e5', name: '槓鈴划船' }, { id: 'e6', name: '引體向上' }, { id: 'c2s', name: '超級組' }],
    'c3': [{ id: 'e7', name: '槓鈴深蹲' }, { id: 'e8', name: '腿推機' }, { id: 'e9', name: '羅馬尼亞硬舉' }, { id: 'c3s', name: '超級組' }],
    'c4': [{ id: 'e10', name: '啞鈴肩推' }, { id: 'e11', name: '側平舉' }, { id: 'e12', name: '滑輪面拉' }, { id: 'c4s', name: '超級組' }],
    'c5': [{ id: 'e13', name: '二頭彎舉' }, { id: 'e14', name: '三頭下壓' }, { id: 'c5s', name: '超級組' }],
    'c6': [{ id: 'e15', name: '捲腹' }, { id: 'e16', name: '棒式' }, { id: 'c6s', name: '超級組' }],
